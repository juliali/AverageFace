...
if len(sys.argv) < 2:
    print(
        ...
        "python scripts\face_landmark_detection.py ..\input_data\president [gender]\n")
    exit()

predictor_path = 'models\shape_predictor_68_face_landmarks.dat'

mean_filename='models\gender_model\mean_image.binaryproto'
gender_net_model_file = 'models\gender_model\deploy_gender.prototxt'
gender_net_pretrained = 'models\gender_model\caffenet_train_iter_10000.caffemodel'
